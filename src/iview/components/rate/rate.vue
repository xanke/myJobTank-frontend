<template>
    <div :class="classes" @mouseleave="handleMouseleave">
        ...
        <div :class="[prefixCls + '-btn-group']" v-if="showBtn">
            <span  :class="[prefixCls + '-btn']"  @click="handleVal('reduce')">-</span>
            <span  :class="[prefixCls + '-btn']"  @click="handleVal('add')">+</span>
        </div>
    </div>
</template>
<script>
            ...
            starCls (value) {
                ...
                return [
                    `${prefixCls}-star`,
                    {
                        ...
                        [`${prefixCls}-star-circle`]: this.circle
